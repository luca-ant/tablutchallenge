...
public class AdvancedWhiteHeuristic implements Heuristic {
	...
	private double WHITE_WEIGHT_BLACK_PAWNS_OVERHANGED = 3.0; // 3
	private double WHITE_WEIGHT_WHITE_PAWNS_OVERHANGED = 1.0; // 1
	private double WHITE_WEIGHT_KING_OVERHANGED = 20.0;
	private double WHITE_WEIGHT_KING_FAVOURITE = 5.0; // 9
	private double WHITE_WEIGHT_GUARDS = 14.0;
	private double WHITE_WEIGHT_STRATEGY = 6.0;
	...
	private void extractValues(State state) {// valuto i quadranti
		int minore = 50;
		// QUADRANTE1
		for (int i = 0; i <= 4; i++) {
			for (int j = 0; j <= 4; j++) {
