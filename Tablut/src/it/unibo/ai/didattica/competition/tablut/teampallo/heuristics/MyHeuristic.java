...
public class MyHeuristic implements Heuristic {
	...
	private static double BLACK_WEIGHT_BLACK_NEAR_KING = 2.5;
	private static double BLACK_WEIGHT_FREE_WAY_KING = 5;
	private static double BLACK_WEIGHT_KING_ON_STAR = 5;
	private static double BLACK_WEIGHT_BLACK_PAWNS_OVERHANGED = 2.5;
	private static double BLACK_WEIGHT_WHITE_PAWNS_OVERHANGED = 2.5;
	private static double BLACK_WEIGHT_BLACKBARRIER = 2.5;

	private static double WHITE_WEIGHT_DIFF_PAWNS = 5;
	private static double WHITE_WEIGHT_COUNT_WHITE_PAWNS = 2.5;
	private static double WHITE_WEIGHT_COUNT_BLACK_PAWNS = 2.5;
	private static double WHITE_WEIGHT_BLACK_NEAR_KING = 3;
	private static double WHITE_WEIGHT_WHITE_NEAR_KING = 2.5;
	private static double WHITE_WEIGHT_FREE_WAY_KING = 5;
	private static double WHITE_WEIGHT_KING_ON_THRONE = 2.5;
	private static double WHITE_WEIGHT_KING_NEAR_THRONE = 2.5;
	private static double WHITE_WEIGHT_KING_ON_STAR = 5;
	private static double WHITE_WEIGHT_BLACK_PAWNS_OVERHANGED = 2.5;
	private static double WHITE_WEIGHT_WHITE_PAWNS_OVERHANGED = 2.5;
