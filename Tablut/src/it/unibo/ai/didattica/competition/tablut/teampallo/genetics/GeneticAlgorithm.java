...
public class GeneticAlgorithm {
	...
	public void mutate(boolean renforce, String daAllenare) {
		...
		case "white":{
			...
			if(modificato)
				System.out.println("[WHITE]: Ho modificato "+scelta+" in "+((renforce)?"positivo":"negativo"));
		...
		case "black":{
			...
			if(modificato)
				System.out.println("[BLACK]: Ho modificato "+scelta+" in "+((renforce)?"positivo":"negativo"));
