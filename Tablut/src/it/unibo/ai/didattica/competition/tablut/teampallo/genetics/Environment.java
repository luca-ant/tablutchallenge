...
public class Environment {
	...
	private Environment() {
		...
		envW.put("WHITE_WEIGHT_COUNT_WHITE_PAWNS",2.5);
		envW.put("WHITE_WEIGHT_COUNT_BLACK_PAWNS",2.5);
		//envW.put("WHITE_WEIGHT_BLACK_NEAR_KING",3.0);
		//envW.put("WHITE_WEIGHT_WHITE_NEAR_KING",1.5);
		envW.put("WHITE_WEIGHT_FREE_WAY_KING",5.0);
		envW.put("WHITE_WEIGHT_KING_ON_THRONE",0.5);
		//envW.put("WHITE_WEIGHT_KING_NEAR_THRONE",1.5);
		envW.put("WHITE_WEIGHT_KING_ON_STAR",5.0);
		envW.put("WHITE_WEIGHT_BLACK_PAWNS_OVERHANGED",2.5);
		envW.put("WHITE_WEIGHT_WHITE_PAWNS_OVERHANGED",2.5);
		...
		parameter.put("WHITE_WEIGHT_COUNT_WHITE_PAWNS",new Parameter("WHITE_WEIGHT_COUNT_WHITE_PAWNS",2.5,0.5,0,5,true));
		parameter.put("WHITE_WEIGHT_COUNT_BLACK_PAWNS",new Parameter("WHITE_WEIGHT_COUNT_BLACK_PAWNS",2.5,0.5,0,5,true));
		//parameter.put("WHITE_WEIGHT_BLACK_NEAR_KING",new Parameter("WHITE_WEIGHT_BLACK_NEAR_KING",2.5,0.5,0,5,true));
		//parameter.put("WHITE_WEIGHT_WHITE_NEAR_KING",new Parameter("WHITE_WEIGHT_WHITE_NEAR_KING",2.5,0.5,0,5,true));
		parameter.put("WHITE_WEIGHT_FREE_WAY_KING",new Parameter("WHITE_WEIGHT_FREE_WAY_KING",2.5,0.5,0,10,true));
		parameter.put("WHITE_WEIGHT_KING_ON_THRONE",new Parameter("WHITE_WEIGHT_KING_ON_THRONE",2.5,0.5,1,5,true));
		//parameter.put("WHITE_WEIGHT_KING_NEAR_THRONE",new Parameter("WHITE_WEIGHT_KING_NEAR_THRONE",2.5,0.5,0,5,true));
		parameter.put("WHITE_WEIGHT_KING_ON_STAR",new Parameter("WHITE_WEIGHT_KING_ON_STAR",2.5,0.5,0,10,true));
		parameter.put("WHITE_WEIGHT_BLACK_PAWNS_OVERHANGED",new Parameter("WHITE_WEIGHT_BLACK_PAWNS_OVERHANGED",2.5,0.5,0,5,true));
		parameter.put("WHITE_WEIGHT_WHITE_PAWNS_OVERHANGED",new Parameter("WHITE_WEIGHT_WHITE_PAWNS_OVERHANGED",2.5,0.5,0,5,true));
		...
		parameter.put("BLACK_WEIGHT_FREE_WAY_KING",new Parameter("BLACK_WEIGHT_FREE_WAY_KING",2.5,0.5,0,5,true));
