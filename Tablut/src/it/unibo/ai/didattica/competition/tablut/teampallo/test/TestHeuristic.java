...
import it.unibo.ai.didattica.competition.tablut.teampallo.heuristics.AdvancedBlackHeuristic;
...
public class TestHeuristic {
	...
	public static void main(String[] args) {
		...
		Heuristic hb = new AdvancedBlackHeuristic();
		Heuristic hw = new AdvancedWhiteHeuristic();
